...
const connect = async () => {
    try {
        await mongoose.connect("mongodb+srv://ignaciotellodev:3376530037518001@cluster0.n9mzqxw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0", {dbName: "products"} )
