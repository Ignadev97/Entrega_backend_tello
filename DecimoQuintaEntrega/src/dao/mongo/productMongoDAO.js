...
export class productMongoDAO {
    ...
    getProducts =  async (parametrosPaginate) => {
        try {
            ...
            let {docs:products, page, hasPrevPage, hasNextPage, prevPage, nextPage, totalPages } = await modeloProducts.paginate(query,{limit:limite, page:pagina, lean: true})

            let resultadoPaginate = {products, totalPages, page, hasPrevPage, hasNextPage, prevPage, nextPage}
